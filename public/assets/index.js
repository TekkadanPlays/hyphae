...
function NetworkList() {
  ...
  }) : null), createElement(Separator, { className: "w-8 my-1 flex-shrink-0 mx-auto" }), state.networks.length > 0 ? createElement(SectionLabel, { text: "IRC" }) : null, ...state.networks.map((network) => {
  ...
  }, createElement("span", { className: "material-symbols-rounded text-xl" }, "add")))), createElement(Separator, { className: "w-8 mx-auto" }), createElement("div", {
...
function LanderContent() {
  ...
  return createElement("div", { className: "max-w-2xl mx-auto px-6 py-10" }, createElement("div", { className: "mb-8" }, createElement("h1", { className: "text-2xl font-bold text-foreground mb-1" }, "Hyphae"), createElement("p", { className: "text-[10px] text-muted-foreground/30 font-mono select-none mb-3" }, "\uD80C\uDF4A\uD80C\uDEFC\uD80C\uDD8F\uD80C\uDEFC\uD80C\uDF4A"), displayName ? createElement("p", { className: "text-muted-foreground" }, "Hey, ", createElement("span", { className: "text-foreground font-medium" }, displayName), "! What would you like to do?") : createElement("p", { className: "text-muted-foreground" }, "IRC chat with Nostr identity, woven together.")), createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8" }, createElement(FeatureCard, {
    icon: "dns",
    title: "IRC Chat",
  ...
  })), connectedNetworks > 0 ? createElement("div", { className: "mb-8" }, createElement(Separator, { className: "mb-4" }), createElement("h2", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3" }, "Active Sessions"), createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3" }, createElement(StatCard, { icon: "dns", label: "IRC Networks", value: `${connectedNetworks} connected` }), createElement(StatCard, { icon: "tag", label: "Channels", value: `${totalChannels} joined` }))) : null, createElement("div", { className: "text-center" }, createElement("p", { className: "text-[10px] text-muted-foreground/25 font-mono select-none" }, "⋆˙\uD80C\uDF4A₊ ⊹˚ \uD81A\uDD67\uD80C\uDEFC˖°\uD80C\uDD91˙⋆")));
}
...
function ModeTabBar() {
  ...
  }, createElement(Tab, { mode: "home", label: "Home", icon: "home" }), createElement(Tab, { mode: "irc", label: "IRC", icon: "dns", badge: connectedCount }));
}
function IrcContent() {
  const state = store.getState();
...
function App() {
  ...
  }, createElement(NetworkList, null), state.settingsOpen ? createElement(SettingsPage, { key: "settings" }) : null, !state.settingsOpen && isHome ? createElement(HomePage, { key: "home" }) : null, !state.settingsOpen && isIrc ? createElement(IrcContent, { key: "irc" }) : null), state.profilePanelPubkey ? createElement(ProfilePanel, {
